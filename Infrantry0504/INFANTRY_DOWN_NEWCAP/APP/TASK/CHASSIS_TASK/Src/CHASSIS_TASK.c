...
chassis_t 		 		 chassis;
/* 如果加上死区， 会出问题， 所以这个值实际上没有用到 */
float pid_chassis_angle_deathband = 0.0f;
...
//  PID_struct_init(&pid_chassis_angle, POSITION_PID, 600, 10, 150,0.05,50);//xisanhao
    PID_struct_init(&pid_chassis_angle, POSITION_PID, 600, 10, 200,0,50);
}
//主要功率控制部分
