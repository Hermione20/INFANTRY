...
void gimbal_parameter_Init(void)
{
    ...
    PID_struct_init(&gimbal_data.pid_yaw_speed, POSITION_PID, 29000, 10000,
                    400, 0.8f, 0); 
//	PID_struct_init(&gimbal_data.pid_yaw_Angle, POSITION_PID, 600, 5,
//                   11, 1.0f, 0);
//    PID_struct_init(&gimbal_data.pid_yaw_speed, POSITION_PID, 25000, 15000,
//                    900, 20.0f, 0); 
...
//                    gimbal_data.gim_ref_and_fdb.yaw_angle_fdb = VISION_YAW_ANGLE_FDB;
    ...
    }else
    {
        ...
        gimbal_data.gim_ref_and_fdb.yaw_angle_ref = gimbal_data.gim_dynamic_ref.yaw_angle_dynamic_ref;
			//pitch轴与yaw轴双环pid计算
    gimbal_data.gim_ref_and_fdb.yaw_motor_input =//K_X*RC_CtrlData.mouse.x + K_V*gimbal_data.gim_ref_and_fdb.yaw_speed_fdb
